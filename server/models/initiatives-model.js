...
const initiativeSchema = new mongoose.Schema({
    ...
    image_url: {
        type: String,
        default: "https://images.unsplash.com/photo-1579492450119-80542d516179?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80"
     },
    description: String,
    status: {
        type: String,
